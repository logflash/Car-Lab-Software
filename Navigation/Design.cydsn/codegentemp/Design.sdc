...
# Date: Wed, 18 Oct 2023 01:41:51 GMT
#set_units -time ns
...
create_generated_clock -name {throttle_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 3 7} [list [get_pins {ClockBlock/dclk_glb_1}]]
...
create_generated_clock -name {pid_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 24001 48001} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\ianh\Documents\Car Lab\Navigation\Design.cydsn\Design.cyprj
# Date: Wed, 18 Oct 2023 01:41:44 GMT

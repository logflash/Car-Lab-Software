...
#define PID_Timer_Resolution                 32u
#define PID_Timer_UsingFixedFunction         0u
...
uint32  PID_Timer_ReadPeriod(void) ;
void    PID_Timer_WritePeriod(uint32 period) ;
uint32  PID_Timer_ReadCounter(void) ;
void    PID_Timer_WriteCounter(uint32 counter) ;
uint32  PID_Timer_ReadCapture(void) ;
...
#define PID_Timer_INIT_PERIOD             19u
#define PID_Timer_INIT_CAPTURE_MODE       ((uint8)((uint8)0u << PID_Timer_CTRL_CAP_MODE_SHIFT))
#define PID_Timer_INIT_TRIGGER_MODE       ((uint8)((uint8)0u << PID_Timer_CTRL_TRIG_MODE_SHIFT))
#if (PID_Timer_UsingFixedFunction)
    #define PID_Timer_INIT_INTERRUPT_MODE (((uint8)((uint8)1u << PID_Timer_STATUS_TC_INT_MASK_SHIFT)) | \
...
***************************************/
    ...
    ***************************************/
    ...
    #define PID_Timer_CONTROL             (* (reg8 *) PID_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define PID_Timer_CAPTURE_LSB         (* (reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define PID_Timer_CAPTURE_LSB_PTR       ((reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define PID_Timer_PERIOD_LSB          (* (reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define PID_Timer_PERIOD_LSB_PTR        ((reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define PID_Timer_COUNTER_LSB         (* (reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define PID_Timer_COUNTER_LSB_PTR       ((reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
    #elif(PID_Timer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define PID_Timer_CAPTURE_LSB         (* (reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define PID_Timer_CAPTURE_LSB_PTR       ((reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define PID_Timer_PERIOD_LSB          (* (reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define PID_Timer_PERIOD_LSB_PTR        ((reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define PID_Timer_COUNTER_LSB         (* (reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
            #define PID_Timer_COUNTER_LSB_PTR       ((reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define PID_Timer_CAPTURE_LSB         (* (reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define PID_Timer_CAPTURE_LSB_PTR       ((reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define PID_Timer_PERIOD_LSB          (* (reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define PID_Timer_PERIOD_LSB_PTR        ((reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define PID_Timer_COUNTER_LSB         (* (reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
            #define PID_Timer_COUNTER_LSB_PTR       ((reg16 *) PID_Timer_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(PID_Timer_Resolution <= 24u)/* 24-bit Timer */
        #define PID_Timer_CAPTURE_LSB         (* (reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define PID_Timer_CAPTURE_LSB_PTR       ((reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define PID_Timer_PERIOD_LSB          (* (reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define PID_Timer_PERIOD_LSB_PTR        ((reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define PID_Timer_COUNTER_LSB         (* (reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define PID_Timer_COUNTER_LSB_PTR       ((reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define PID_Timer_CAPTURE_LSB         (* (reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define PID_Timer_CAPTURE_LSB_PTR       ((reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define PID_Timer_PERIOD_LSB          (* (reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define PID_Timer_PERIOD_LSB_PTR        ((reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define PID_Timer_COUNTER_LSB         (* (reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
            #define PID_Timer_COUNTER_LSB_PTR       ((reg32 *) PID_Timer_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define PID_Timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) PID_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )

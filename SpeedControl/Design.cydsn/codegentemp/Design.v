...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e14eb23f-a59b-49fa-9212-7d32484bf574/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Motor_PWM_net;
	wire [0:0] tmpFB_0__Motor_PWM_net;
	wire [0:0] tmpIO_0__Motor_PWM_net;
	wire [0:0] tmpINTERRUPT_0__Motor_PWM_net;
	electrical [0:0] tmpSIOVREF__Motor_PWM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_PWM
		 (.oe(tmpOE__Motor_PWM_net),
		  .y({Net_105}),
		  .fb({tmpFB_0__Motor_PWM_net[0:0]}),
		  .io({tmpIO_0__Motor_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_PWM_net),
		  .interrupt({tmpINTERRUPT_0__Motor_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("c5b71fcd-99c1-406b-8233-f561fc0b2fe6"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Servo_PWM_net;
	wire [0:0] tmpFB_0__Servo_PWM_net;
	wire [0:0] tmpIO_0__Servo_PWM_net;
	wire [0:0] tmpINTERRUPT_0__Servo_PWM_net;
	electrical [0:0] tmpSIOVREF__Servo_PWM_net;

	cy_psoc3_pins_v1_10
		#(.id("0c550e58-250c-493f-aed4-3dda0a12ac02"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Servo_PWM
		 (.oe(tmpOE__Servo_PWM_net),
		  .y({Net_146}),
		  .fb({tmpFB_0__Servo_PWM_net[0:0]}),
		  .io({tmpIO_0__Servo_PWM_net[0:0]}),
		  .siovref(tmpSIOVREF__Servo_PWM_net),
		  .interrupt({tmpINTERRUPT_0__Servo_PWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Servo_PWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_4 XBee (
        ...
        .tx_data(Net_157),
        .tx_en(Net_158),
        .tx_interrupt(Net_159));
    defparam XBee.Address1 = 0;
    defparam XBee.Address2 = 0;
    defparam XBee.EnIntRXInterrupt = 1;
